...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.infection.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.infections.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('infections') ? 'is-invalid' : '' }}" type="number" name="infections" id="infections" value="{{ old('infections', '0') }}" step="1" required>
